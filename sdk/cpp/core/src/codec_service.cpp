...
{
    YLOG_INFO("Performing encode operation on entity '{}'", entity.yang_name);
    ...
    YLOG_INFO("Entity '{}' encoding result:\n{}", entity.yang_name, result);
    return result;
}
...
{
    YLOG_INFO("Performing decode operation on:\n{}", payload);
