...
import (
	...
	"strconv"
	"strings"
	ifmgrCfg "github.com/CiscoDevNet/ydk-go/ydk/models/cisco_ios_xr/ifmgr_cfg"
	"github.com/CiscoDevNet/ydk-go/ydk/providers"
	"github.com/CiscoDevNet/ydk-go/ydk/services"
	"github.com/CiscoDevNet/ydk-go/ydk"
)

// configCfg adds config data to global_interface_configuration object
func configCfg(cfg *ifmgrCfg.GlobalInterfaceConfiguration) {
	cfg.LinkStatus = ifmgrCfg.LinkStatusEnum_default_
}
...
func main() {
	...
	cfg := ifmgrCfg.GlobalInterfaceConfiguration{}	// create object
	configCfg(&cfg)									// add object configuration

	// create configuration on NETCONF device
	service.Create(&provider, &cfg)
}
