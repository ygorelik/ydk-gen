...
import (
	...
	"strconv"
	"strings"
	rollback "github.com/CiscoDevNet/ydk-go/ydk/models/cisco_ios_xr/cfgmgr_rollback_act"
	"github.com/CiscoDevNet/ydk-go/ydk/providers"
	"github.com/CiscoDevNet/ydk-go/ydk/services"
	"github.com/CiscoDevNet/ydk-go/ydk"
)

// prepareRpc adds RPC input data to rollbackRpc object
func prepareRpc(rollbackRpc *rollback.RollBackConfigurationLast) {
	rollbackRpc.Input.Count = 1
}
...
func main() {
	...
	rollbackRpc := rollback.RollBackConfigurationLast{}		// create object
	prepareRpc(&rollbackRpc)								// add RPC input

	// execute RPC on NETCONF device
	service.ExecuteRpc(&provider, &rollbackRpc, nil)
}
