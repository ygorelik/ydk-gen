...
import (
	...
	"strconv"
	"strings"
	snmpTestTrap "github.com/CiscoDevNet/ydk-go/ydk/models/cisco_ios_xr/snmp_test_trap_act"
...
func main() {
	...
	rpc := snmpTestTrap.SnmpColdStart{}

	// execute RPC on NETCONF device
	service.ExecuteRpc(&provider, &rpc, nil)
}
